...
(function() {
  var cleanupSimpleMDE, simplemde;

  simplemde = null;

  cleanupSimpleMDE = function() {
    if (simplemde != null) {
...
(function() {
  App["case"] = App.cable.subscriptions.create("CaseChannel", {
    ...
    received: function(data) {
      return $('#realtime_task').prepend(data['message']);
    },
    accomplish: function() {
      return this.perform('accomplish');
    }
  });

  $(document).ready(function() {
    return $('[id^="my_stop_notify_"]').on('click', function(event) {
